...
public class RegistryDemo {
    public static void main(String[] args) {
        ...
        try {
            // 创建一个注册表项
            String testPath = "HKEY_SOFTWARE\\DATABASE\\MongoDB";
            // 找到testPath這個注册表项
            RegistryKey keyByPath = registry.getKeyByPath(testPath);
            boolean b = keyByPath.removeSubKey("HKEY_SOFTWARE\\DATABASE\\MongoDB\\dc_mongodb_host");
            if (b){
